...
import com.example.navegacion.entities.User
...
class Fragment1 : Fragment() {
    ...
    override fun onCreateView(
        ...
        Log.d("MainActivity", newUser.saludar())        //escribe por consola
        ...
        vista = inflater.inflate(R.layout.fragment_fragment1, container, false)
        label = vista.findViewById(R.id.txtView1)
